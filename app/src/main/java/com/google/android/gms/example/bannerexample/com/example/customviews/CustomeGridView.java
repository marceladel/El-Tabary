 ...
 */
public class CustomeGridView extends ArrayAdapter<String> {

    Context context;
    ArrayList<String> headersNames=new ArrayList<String>();
    private static LayoutInflater inflater=null;
    public CustomeGridView(Context context,ArrayList<String> headers) {
        super(context, R.layout.grid_row, headers);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
       ...
       // holder.text.setTextDirection(View.TEXT_DIRECTION_RTL);
        holder.text.setTypeface(new Constants(context).getTypeFaceStandard(context));
